<div class="offcanvas offcanvas-start" id="demo">
              ...
              <div class="offcanvas-body">
                <ul class="nav flex-column">
                  <li class="nav-item perfil-link">
                    <a href="alterar_perfil.php" class="nav-link perfil-link">
                  ...
                  <li class="nav-item atendimento-link">
                    <a href="alterar_endereco.php" class="nav-link">
                      <span>Endereço</span>
                      <i>
                ...
                <li class="nav-item atendimento-link">
                  <a href="alterar_compras.php" class="nav-link ">
            ...
            <div class="container_fluid ms-5">
